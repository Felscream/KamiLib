...
public static class ZoneFilterListDraw
{
    ...
    public static void DrawAddRemoveHere(Setting<List<uint>> selectedZones)
    {
        InfoBox.Instance
               ...
               .BeginTable()
               .BeginRow()
               .AddDisabledButton(Strings.Common_Add, () => { Add(selectedZones, Service.ClientState.TerritoryType); },
    ...
    public static void DrawTerritorySearch(Setting<List<uint>> selectedZones, ZoneFilterType zoneFilterType)
    {
        InfoBox.Instance
               ...
               .AddAction(() =>
               {
                   ...
                   if (ImGui.InputTextWithHint("###TerritorySearch", Strings.ZoneFilterList_Search, ref _searchString,
